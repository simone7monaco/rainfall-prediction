...
def main(args):
	...
	early_stop_1 = EarlyStopping(monitor="val_loss_segm", min_delta=0.08, patience=10, verbose=False, mode="min")
	...
	if(args.network_model == "unet_3"):
		early_stop_2 = EarlyStopping(monitor="val_loss", min_delta=0.004, patience=10, verbose=False, mode="min")
